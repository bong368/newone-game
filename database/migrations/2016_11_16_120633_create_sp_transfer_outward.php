...
class CreateSpTransferOutward extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $sql = <<<SQL
CREATE PROCEDURE sp_transfer_outward(
    IN app_id INT(10),
    IN member_id INT(10),
...
proc_label:BEGIN
    ...
    START TRANSACTION;
        ...
        VALUES (app_id, member_id, tx_amount, balance, 1, tx_no, tx_at);
...
SQL;
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_transfer_outward');
    }
}
